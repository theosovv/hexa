const tokens = {
  ...
  "colors.surface.tertiary": {
    "value": "#3a3a3a",
    "variable": "var(--colors-surface-tertiary)"
  },
  ...
  "colors.accent.purple": {
    "value": "#8b5cf6",
    "variable": "var(--colors-accent-purple)"
  },
  "colors.accent.blue": {
    "value": "#3b82f6",
    "variable": "var(--colors-accent-blue)"
  },
  "colors.accent.green": {
    "value": "#10b981",
  ...
  "colors.accent.red": {
    "value": "#ef4444",
    "variable": "var(--colors-accent-red)"
  },
  "colors.accent.cyan": {
    "value": "#06b6d4",
  ...
  "shadows.xl": {
    "value": "0 12px 32px rgba(0, 0, 0, 0.6)",
    "variable": "var(--shadows-xl)"
  },
  "shadows.glow": {
    "value": "0 0 20px rgba(102, 126, 234, 0.4)",
